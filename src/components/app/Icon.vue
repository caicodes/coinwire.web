        ...
        <g id="coinwire__icon">
          <g id="Dot__lower">
            <g id="rotator" style="opacity: 0">
              ...
              <rect
                ...
                width="312.68"
                height="312.68"
                transform="translate(-112.7 272.08) rotate(-45)"
                style="
                  fill: none;
                  stroke: #000;
                  stroke-miterlimit: 10;
          ...
          <g id="Dot__center">
            ...
            <path
              ...
              fill="var(--svg-dot-center-path)"
            />
          </g>
          <g id="C__outer">
            <g id="rotator-5" style="opacity: 100%">
              <g>
                <line
                  x1="272.08"
                  x2="272.08"
...
onMounted(() => {
  console.log("giddy up bitch")

  animation
    .to("#C__outer", { scale: 1.1, rotate: 360 })
    .to("#Dot__lower", { scale: 0.618, rotate: "-720deg" })
    .to("#Dot__upper", { scale: 0.618, rotate: "360deg" })
    .to("#C__Inner", { rotate: "-360deg" })
    .to("#Dot__center", { rotate: "360deg" })
    .to("#C__outer", { scale: 0.85, rotate: 720 })
})
</script>
...
:root {
  --svg-c-outer-path: hotpink;
  --svg-dot-center-path: lime;
  --svg-c-inner-path: rebeccapurple;
  --svg-dot-upper-path: hotpink;
  --svg-dot-lower-path: lime;
}
</style>
