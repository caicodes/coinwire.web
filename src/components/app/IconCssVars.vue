...
:root {
  --svg-dot-center-path: var(--bg-primary);
  --svg-c-outer-path: var(--bg-primary);
  --svg-c-inner-path: var(--primary);
  --svg-dot-upper-path: var(--accent);
  --svg-dot-lower-path: var(--accent);
}
</style>
